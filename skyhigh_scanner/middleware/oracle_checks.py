...
ORACLE_CVES = [
    ...
    {"cve": "CVE-2018-3110", "affected": ">=12.1,<=12.2.0.1", "severity": "CRITICAL",
     "name": "Oracle DB Java VM Remote Code Execution"},
    {"cve": "CVE-2021-2351", "affected": ">=12.1,<=21.3", "severity": "CRITICAL",
     "name": "Oracle JDBC Driver Takeover"},
    {"cve": "CVE-2022-21500", "affected": ">=19.0,<=21.6", "severity": "HIGH",
     "name": "Oracle DB Information Disclosure"},
    {"cve": "CVE-2020-2735", "affected": ">=11.2,<=19.6", "severity": "HIGH",
     "name": "Oracle DB Java VM Privilege Escalation"},
    {"cve": "CVE-2019-2729", "affected": ">=12.1,<=19.3", "severity": "CRITICAL",
     "name": "Oracle DB XMLDecoder Deserialization RCE"},
    {"cve": "CVE-2022-21393", "affected": ">=12.2,<=21.4", "severity": "HIGH",
     "name": "Oracle DB Java VM Unauthorized Access"},
    {"cve": "CVE-2023-21829", "affected": ">=19.0,<=21.8", "severity": "HIGH",
     "name": "Oracle DB RDBMS Security Bypass"},
    {"cve": "CVE-2020-14740", "affected": ">=12.1,<=19.8", "severity": "MEDIUM",
     "name": "Oracle DB Data Pump Information Disclosure"},
    {"cve": "CVE-2024-21093", "affected": ">=19.0,<=21.13", "severity": "HIGH",
     "name": "Oracle RDBMS Unauthorized Data Access"},
]
